...
function StockCard({ symbol, shares, price, change = 0, onUpdateShares, onDelete, buyPrice, historyData }: StockCardProps) {
  ...
  return (
    <div className="relative bg-white border-black border-b border-r p-8 flex flex-col h-full group hover:bg-zinc-50 transition-colors overflow-hidden">
      
      {/* SURGICAL A: ROHOVÁ "X" KOTVA - teď je součástí mřížky */}
      <button 
        onClick={onDelete} 
      ...
      {/* GRAPH - isAnimationActive={false} pro syrový look */}
      ...
      <div className="mt-auto">
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 border-t border-black divide-x divide-black -mx-8 -mb-8 min-h-[110px]">
            ...
            {/* PERFORMANCE - SURGICAL B: Sjednocená opacity labelů */}
